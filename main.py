...
def contact():
    mess._show(title='Contact us', message="Please contact us on : '18BCS6640cuchd.in' ")
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="orange",bg="#262523" ,width=45 ,height=1,font=('times', 18, ' bold '))
